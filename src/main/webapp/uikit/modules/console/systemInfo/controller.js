function systemInfoController($rootScope, $scope, $log, $http) {
...
//	$scope.refreshSessions();
	...
	$log.debug('systemInfoController...');
}
appControllers.controller('systemInfoController', systemInfoController);
